...
def smoothing_coefficients_b_spline(paras, ratio=0.3):
    # CVXPY is used only by this synthetic-data helper.  Keep it out of the
    # PointSGRADE MKL solver import path, where importing CVXPY probes optional
    # native solvers such as OSQP on Windows.
    import cvxpy as cp
